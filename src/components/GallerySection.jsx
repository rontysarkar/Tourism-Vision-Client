            ...
            {/* {data?.map(({ imageLink }, index) => ( */}
                <div data-aos="fade-right" data-aos-duration='1000' >
                    <img
                        ...
                        src={"https://i.ibb.co/ckdtVPF/SRL-image-1.png"}
                        alt="gallery-photo"
                    />
                </div>
                <div data-aos="zoom-in" data-aos-duration='1000' >
                    <img
                        className="h-56 w-full max-w-full rounded-lg object-cover object-center"
                        src={'https://i.ibb.co/G5Y1sVQ/SRL-image-5.png'}
                        alt="gallery-photo"
                    />
                </div>
                ...
                <div data-aos="zoom-in" data-aos-duration='1000' >
                    <img
                        className="h-56 w-full max-w-full rounded-lg object-cover object-center"
                        src={'https://i.ibb.co/J5yzYdL/SRL-image-7.png'}
                        alt="gallery-photo"
                    />
                </div>
                <div data-aos="fade-left" data-aos-duration='1000' >
                    <img
                        className="h-56 w-full max-w-full rounded-lg object-cover object-center"
                        src={'https://i.ibb.co/42WZHt5/SRL-image-13.png'}
                        alt="gallery-photo"
                    />
                </div>
                <div data-aos="fade-right" data-aos-duration='1000' >
                    <img
                        className="h-56 w-full max-w-full rounded-lg object-cover object-center"
                        src={'https://i.ibb.co/d43WhhS/SRL-image-2.png'}
                        alt="gallery-photo"
                    />
                </div>
                <div data-aos="zoom-in" data-aos-duration='1000' >
                ...
                <div data-aos="fade-left" data-aos-duration='1000' >
                    <img
                        className="h-56 w-full max-w-full rounded-lg object-cover object-center"
                        src={'https://i.ibb.co/YdVSgDP/best-things-to-do-phnom-penh-image-5.jpg'}
                        alt="gallery-photo"
                    />
                </div>
            {/* ))} */}
